...
title: Write Events
description: >-
  writeEvents appends Nimbus events to EventSourcingDB with mapping, trace
  context, and optional preconditions.
---
