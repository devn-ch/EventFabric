...
title: Client Setup
description: >-
  setupEventSourcingDBClient initializes a singleton EventSourcingDB client with
  connectivity checks and auth.
---
...
See the [Event Observer](/eventsourcingdb/event-observer) documentation for details on configuring observers.
...
<Card title="Tip">
You typically don't need to call `getEventSourcingDBClient` directly. The [`writeEvents`](/eventsourcingdb/write-events) and [`readEvents`](/eventsourcingdb/read-events) functions handle this internally.
</Card>
